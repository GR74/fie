...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/scenario", label: "Lab", icon: <FlaskConical className="w-5 h-5" />, description: "Global what-if analysis" },
  { href: "/calibration", label: "Calibration", icon: <Target className="w-5 h-5" />, description: "Model validation" },
  { href: "/scenarios", label: "Scenarios", icon: <Bookmark className="w-5 h-5" />, description: "Saved configurations" },
];

const QUICK_LINKS: NavItem[] = [
  { href: "/games/michigan_at_osu_2026", label: "Michigan Game", icon: <Radio className="w-4 h-4" />, description: "Hero simulator" },
  { href: "/games/michigan_at_osu_2026/live", label: "Live Mode", icon: <Radio className="w-4 h-4" />, description: "Game day dashboard" },
];
